...
class addnewFormRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'phoneNumb' => 'required|min:10|max:20',
            ...
            'npwp' => 'required|min:15|max:20|unique:users',
            'accNumb' => 'required|min:10|max:20|unique:users',
            'bpjsKerja' => 'required|min:10|max:20|unique:users',
            'health' => 'required|min:10|max:20|unique:users',
            'bpjsSehat' => 'required|min:10|max:20|unique:users',
