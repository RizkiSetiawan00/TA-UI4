    ...
    <script>
        function addRows()
        { 
            var table = document.getElementById('bankNameInput');
...
<!-- Modal bankNew - ADD -->
<div class="modal fade" id="bankEdit" tabindex="-1" aria-labelledby="bankEdit" aria-hidden="true">
    <div class="modal-dialog">
    <div class="modal-content">
    <div class="modal-header">
        <h1 class="modal-title fs-5" id="bankNew">Edit Bank data</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <div class="modal-body">
        <form action="/bankEdit/{{ $banknya->id }}" method="post" enctype="multipart/form-data">
            @csrf
            @method("put")
