            ...
            <div class="row" id="bankData"  aria-labelledby="flush-headingOne" data-bs-parent="#bankDataParent">
                ...
                <div class="table-responsive-xl">
                    <div class="col-auto d-flex justify-content-end font-bold ">
                        <button type="button" class="btnaddData shadow-sm p-2 align-items-center font-color1" data-bs-toggle="modal" data-bs-target="#AddprojectManager">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th scope="col" style="width: 120px">Deadline</th>
                        ...
                        <tr>
                            ...
                            <td>{{  date('d F Y\ H:i:s', strtotime($projeknya->deadline))  }}</td>
                            <td>{{$projeknya->User->name}}</td>
                            <td>
                                @if($projeknya->status == 1)
                                @endif
                            </td>
                            ...
                            <td>
                                <form action="{{ route('manager.deleteProject', $projeknya->id) }}" method="post">
                                    @csrf
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#EditprojectManager">Edit</button>
